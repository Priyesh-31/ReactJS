...
<div class="flex flex-col items-center">
        <img class="w-24 h-24 mb-6 rounded-full" src="https://avatars.githubusercontent.com/u/8152403?v=4" alt="Bonnie image"/>
        <h5 class="mb-0.5 text-xl font-semibold tracking-tight text-heading">{username}</h5>
        <span class="text-sm text-body">Software Designer</span>
